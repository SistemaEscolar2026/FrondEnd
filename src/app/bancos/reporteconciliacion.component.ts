...
*/
@Component({
    templateUrl: './reporteconciliacion.component.html',
    styleUrls: ['./reporteconciliacion.component.scss']
})
 ...
 */
   ...
   */
    ...
    buscarpdf() {
        this.spinner.show();
        this.bancosService.repoteConciliacion("PDF", globales.cia, this.iDocumento.bdo_fechaini, this.iDocumento.bdo_fechafin, this.iDocumento.ban_codigo, this.iDocumento.bcb_codigo, this.iDocumento.bnc_codigo, Funcion.returdatosession("usuario").us_login,"prueba").subscribe((results) => {
            try {
                try {
