...
*/
@Component({
    templateUrl: './reportedocumentobancario.component.html',
    styleUrls: ['./reportedocumentobancario.component.scss']
})
export class ReporteDocumentoBancarioComponent implements OnInit {
    /**
 ...
 */
   ...
   */
    ...
    buscarpdf() {
        this.spinner.show();
        this.bancosService.repoteDocumentoBancario("PDF", globales.cia, this.iDocumento.bdo_fechaini, this.iDocumento.bdo_fechafin, this.iDocumento.ban_codigo, this.iDocumento.bcb_codigo, this.iDocumento.bnc_codigo, Funcion.returdatosession("usuario").us_login,"prueba").subscribe((results) => {
            try {
                try {
  ...
  */
    ...
    mensaje(_tipo: string, _mensaje: string) {
        this.llamarmodal = _tipo + "|Reporte Documento Bancario|" + _mensaje + "|" + Funcion.Ramdon().toString();
    }
