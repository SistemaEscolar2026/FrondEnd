...
*/
@Component({
    selector: 'app-reversoasientoapertura',
    templateUrl: './reversoasientoapertura.component.html',
    styleUrls: ['./reversoasientoapertura.component.scss']
})
export class ReversoAsientoAperturaComponent {
    ...
    procesar() {
        ...
        this.spinner.show();
        this.boletoService.reversoAsiento(cierrermodulo).subscribe(data => {
            try {
                if (data.success) {
                    ...
                    this.modalmensaje("3", "Se Reverso el asiento sin novedad");
                }
                this.spinner.hide();
            } catch (e) {
                this.modalmensaje("3", "Se Reverso el asiento sin novedad");
