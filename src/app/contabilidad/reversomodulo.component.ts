...
*/
@Component({
    selector: 'app-reversomodulo',
    templateUrl: './reversomodulo.component.html',
    styleUrls: ['./reversomodulo.component.scss']
})
export class ReversoModuloComponent {
    ...
    procesar() {
        ...
        this.spinner.show();
        this.boletoService.reversoCierre(cierrermodulo).subscribe(data => {
            try {
                if (data.success) {
