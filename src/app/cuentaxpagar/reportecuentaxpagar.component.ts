...
*/
@Component({
    templateUrl: './reportecuentaxpagar.component.html',
    styleUrls: ['./reportecuentaxpagar.component.scss']
})
export class ReporteCuentaxPagarComponent implements OnInit {
    /**
  ...
  */
    ...
    modalRef: any;
    llamarmodal: string = "";
    ColumnaDetalle: any[] = ['#', 'F. Emisión', 'RUC', 'Razón Social', 'Detalle', 'No. De factura', 'No. Autorización', 'Sub. 12%', 'Sub. 0%', 'No objeto', 'IVA', 'Total'];
 ...
 */
    ...
    buscarexcel() {
        this.spinner.show();
        this.boletoService.repoteCuentaxPagar("EXC", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cl_codigo, globales.nomMaquina, Funcion.ReturnUsuario().us_login).subscribe((results) => {
            try {
                ...
                a.href = fileURL;
                a.download = "ReporteCuentaxPagar.xlsx";
                a.click();
                this.spinner.hide();
    ...
    buscarpdf() {
        this.spinner.show();
        this.boletoService.repoteCuentaxPagar("PDF", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cl_codigo, globales.nomMaquina, Funcion.ReturnUsuario().us_login).subscribe((results) => {
            try {
                try {
    ...
    buscarcuentaxcobrar() {
        this.spinner.show();
        this.boletoService.repoteCuentaxPagarVisual("", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cl_codigo).subscribe(data => {
            try {
