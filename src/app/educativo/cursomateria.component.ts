...
*/
@Component({
    templateUrl: './cursomateria.component.html',
    styleUrls: ['./cursomateria.component.scss']
})
export class CursoMateriaComponent implements OnInit {
    /**
...
*/
    ...
    habilitarfrom(val: Number) {
        switch (val) {
            case 1:
                ...
                this.paisfrom.controls['codigocurso'].disable();
            ...
            case 2:
                ...
                this.paisfrom.controls['codigocurso'].enable();
  ...
  */
    insertpais() {
        this.spinner.show();
        this.model.cucodigo = this.paisfrom.controls['codigocurso'].value.toString().toUpperCase();
        this.model.lista = this.listaHasta;
        this.mantenimientoService.insertCursoMateria(this.model).subscribe(data => {
            try {
                if (data.success) {
                    this.notifier.showok(data.msgError, "")
                    this.limpiabotones(1);
  ...
  */
    limpiarpais() {
        ...
        this.paisfrom.controls['codigocurso'].setValue("");
    ...
    seleciona() {
        this.listaDesde = [];
        this.listaHasta = [];
        this.llenarMateriaCurso(this.paisfrom.controls['codigocurso'].value.toString());

    }
    llenarMateriaCurso( tipo_pagina: string): any {
