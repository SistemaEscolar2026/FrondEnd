...
*/
@Component({
    templateUrl: './procesofacturacionanu.component.html',
    styleUrls: ['./procesofacturacionanu.component.scss']
})
export class ProcesoFacturacionAnuComponent implements OnInit {
    /**
 ...
 */
    ...
    buscarfacturacion() {
        this.spinner.show();
        this.boletoService.repoteFacturacionVisualAnu("", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cl_codigo.toString()).subscribe(data => {
            try {
...
*/
  ...
  */
    ...
    confirmarguardar(row: any) {
        this.rowlinea = row;
            this.mensaje("4", "Esta seguro de Reversar la factura");
    ...
    procesar() {
        ...
        this.spinner.show();
        this.facturacionService.procesarFacturaAnu(this.rowlinea.fa_codigo).subscribe(data => {
            try {
                if (data.success) {
...
*/
  ...
  */
    ...
    mensaje(_tipo: string, _mensaje: string) {
        this.llamarmodal = _tipo + "|Proceso de Reverso Facturacion |" + _mensaje + "|" + Funcion.Ramdon().toString();
    }
