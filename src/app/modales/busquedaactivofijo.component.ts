...
@Component({
  standalone: true,
  selector: 'app-busquedaactivofijo',
  templateUrl: './busquedaactivofijo.component.html',
  styleUrls: ['./busquedaactivofijo.component.scss'],
  imports: [
    FormsModule,
    ReactiveFormsModule,
    MatButtonModule,
...
export class BusquedaActivoFijoComponent implements OnInit {
  /**
...
*/
  clickGrid(row: any) {
    this.limpiarColor();
    this.selectedActivoFijo = row.afcodigo
    row.color = "FT";
  }
  /**
