...
@Component({
    standalone: true,
    selector: 'app-busquedaaerolinea',
    templateUrl: './busquedaaerolinea.component.html',
    styleUrls: ['./busquedaaerolinea.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaAerolineaComponent implements OnInit {
    /**
