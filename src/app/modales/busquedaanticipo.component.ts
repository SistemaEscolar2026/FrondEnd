...
@Component({
    standalone: true,
    selector: 'app-busquedaanticipo',
    templateUrl: './busquedaanticipo.component.html',
    styleUrls: ['./busquedaanticipo.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaAnticipoComponent implements OnInit {
    /**
  ...
  */
    ColumnaDetalle: any[] = ['N° Anticipo', 'Empleado',  'Fecha Anticipo'];
    /**
