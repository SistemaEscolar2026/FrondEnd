...
@Component({
    standalone: true,
    selector: 'app-busquedaasientocontable',
    templateUrl: './busquedaasientocontable.component.html',
    styleUrls: ['./busquedaasientocontable.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaAsientoContableComponent implements OnInit {
  ...
  */
    ColumnaDetalle: any[] = ['N° Asiento', 'Fecha Asiento', 'Glosa Asiento'];
    /**
