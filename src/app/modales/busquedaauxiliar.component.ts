...
@Component({
    standalone: true,
    selector: 'app-busquedaauxiliar',
    templateUrl: './busquedaauxiliar.component.html',
    styleUrls: ['./busquedaauxiliar.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaAuxiliarComponent implements OnInit {
    /**
