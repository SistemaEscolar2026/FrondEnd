...
@Component({
    standalone: true,
    selector: 'app-busquedabancos',
    templateUrl: './busquedabancos.component.html',
    styleUrls: ['./busquedabancos.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
  ...
  */
    aceptar() {
        if (this.selectedComision === "") {
            this.toastr.info("Debe seleccionar un Bancos...", 'Busqueda Bancos');
        } else {
            this.cerrar();
        }
    }
