...
@Component({
    standalone: true,
    selector: 'app-busquedacomision',
    templateUrl: './busquedacomision.component.html',
    styleUrls: ['./busquedacomision.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaComisionComponent implements OnInit {
    /**
  * DEFINICION DE VARIABLE ENTRADA DE LISTADO DE CLIENTE
  */
    @Input() listadocomision: any[] = [];
    /**
  ...
  */
    ColumnaDetalle: any[] = ['Entidad', 'Porcentaje', 'Valor'];
    /**
  ...
  */
    ngOnInit() {
        this.comision = this.listadocomision;
    }
    /**
  ...
  */
    limpiarColor() {
        for (var i = 0; i < this.comision.length; i++) {
            this.comision[i].color = "";
        }
    }
    /**
