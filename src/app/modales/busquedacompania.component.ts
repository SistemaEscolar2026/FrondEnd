...
@Component({
    standalone: true,
    selector: 'app-busquedacompania',
    templateUrl: './busquedacompania.component.html',
    styleUrls: ['./busquedacompania.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaCompaniaComponent implements OnInit {
    /**
  * DEFINICION DE VARIABLE ENTRADA DE LISTADO DE CLIENTE
  */
    @Input() listacompania: any[] = [];
    /**
  ...
  */
    ColumnaDetalle: any[] = ['Ruc Agencia', 'Nombre Agencia'];
    /**
  ...
  */
    ngOnInit() {
        this.formaaerolinea = this.listacompania;
    }
    /**
  ...
  */
    aceptar() {
        if (this.selectedComision === "") {
            this.toastr.info("Debe seleccionar una Agencia...", 'Busqueda Agencia');
        } else {
            this.cerrar();
        }
    }
