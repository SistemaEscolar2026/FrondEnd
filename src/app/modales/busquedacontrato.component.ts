...
@Component({
  standalone: true,
  selector: 'app-busquedacontrato',
    templateUrl: './busquedacontrato.component.html',
    styleUrls: ['./busquedacontrato.component.scss'],
  imports: [
    FormsModule,
    ReactiveFormsModule,
    MatButtonModule,
...
*/
  ngOnInit() {
      this.contrato = this.listadocontrato;
  }
  /**
...
*/
  limpiarColor() {
      for (var i = 0; i < this.contrato.length; i++) {
          this.contrato[i].color = "";
    }
  }
  /**
...
*/
  aceptar() {
    if (this.selectedCliente === "") {
      this.toastr.info("Debe seleccionar un Contrato...", 'Busqueda Contrato');
    } else {
      this.cerrar();
    }
  }
