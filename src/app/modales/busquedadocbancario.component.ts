...
@Component({
    standalone: true,
    selector: 'app-busquedadocbancario',
    templateUrl: './busquedadocbancario.component.html',
    styleUrls: ['./busquedadocbancario.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaDocBancarioComponent implements OnInit {
    /**
  * DEFINICION DE VARIABLE ENTRADA DE LISTADO DE CLIENTE
  */
    @Input() listbancos: any[] = [];
    /**
  ...
  */
    ColumnaDetalle: any[] = ['Codigo', 'Tipo Documento', 'Banco', 'Cuenta Bancaria'];
    /**
  ...
  */
    aceptar() {
        if (this.selectedComision === "") {
            this.toastr.info("Debe seleccionar un Documento Bancario...", 'Busqueda Documento Bancario');
        } else {
            this.cerrar();
        }
    }
