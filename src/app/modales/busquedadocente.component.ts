...
@Component({
  standalone: true,
    selector: 'app-busquedadocente',
    templateUrl: './busquedadocente.component.html',
    styleUrls: ['./busquedadocente.component.scss'],
  imports: [
    FormsModule,
    ReactiveFormsModule,
    MatButtonModule,
...
*/
  ngOnInit() {
      this.docente = this.listadodocente;
  }
  /**
...
*/
  limpiarColor() {
      for (var i = 0; i < this.docente.length; i++) {
          this.docente[i].color = "";
    }
  }
  /**
