...
@Component({
    standalone: true,
    selector: 'app-busquedadoordenpago',
    templateUrl: './busquedadoordenpago.component.html',
    styleUrls: ['./busquedadoordenpago.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaOrdenPagoComponent implements OnInit {
    /**
  ...
  */
    ColumnaDetalle: any[] = ['Codigo', 'Banco', 'Tipo Cuenta', 'Cuenta Bancaria'];
    /**
  ...
  */
    aceptar() {
        if (this.selectedComision === "") {
            this.toastr.info("Debe seleccionar una Orden Pago ...", 'Busqueda Orden Pago');
        } else {
            this.cerrar();
        }
    }
