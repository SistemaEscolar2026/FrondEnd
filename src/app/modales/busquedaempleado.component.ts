...
@Component({
  standalone: true,
    selector: 'app-busquedaempleado',
    templateUrl: './busquedaempleado.component.html',
    styleUrls: ['./busquedaempleado.component.scss'],
  imports: [
    FormsModule,
    ReactiveFormsModule,
    MatButtonModule,
...
*/
  ngOnInit() {
      this.empleado = this.listadoempleado;
  }
  /**
...
*/
  aceptar() {
    if (this.selectedCliente === "") {
        this.toastr.info("Debe seleccionar un Empleado...", 'Busqueda Empleado');
    } else {
      this.cerrar();
    }
  }
