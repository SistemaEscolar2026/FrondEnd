...
@Component({
  standalone: true,
  selector: 'app-busquedaentidad',
  templateUrl: './busquedaentidad.component.html',
    styleUrls: ['./busquedaentidad.component.scss'],
  imports: [
    FormsModule,
    ReactiveFormsModule,
    MatButtonModule,
...
*/
  ngOnInit() {
    this.clientes = this.listadocliente;
  }
  /**
