...
@Component({
    standalone: true,
    selector: 'app-busquedaestado',
    templateUrl: './busquedaestado.component.html',
    styleUrls: ['./busquedaestado.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaEstadoComponent implements OnInit {
    /**
