...
@Component({
    standalone: true,
    selector: 'app-busquedafactura',
    templateUrl: './busquedafactura.component.html',
    styleUrls: ['./busquedafactura.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaFacturaComponent implements OnInit {
  ...
  */
    ColumnaDetalle: any[] = ['Factura', 'Fecha Factura', 'Entidad', 'Total'];
    /**
  ...
  */
    aceptar() {
        if (this.selectedComision === "") {
            this.toastr.info("Debe seleccionar una Factura...", 'Busqueda Factura');
        } else {
            this.cerrar();
        }
    }
