...
@Component({
    standalone: true,
    selector: 'app-busquedafacturaPagar',
    templateUrl: './busquedafacturaPagar.component.html',
    styleUrls: ['./busquedafacturaPagar.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaFacturaPagarComponent implements OnInit {
    /**
  ...
  */
    ColumnaDetalle: any[] = ['Codigo Cuenta x Pagar', 'Fecha Registro', 'Tipo Referencia', 'Numero Referencia', 'Orden Compra', 'Tipo Orden Compra'];
    /**
  ...
  */
    clickGrid(row: any) {
        this.limpiarColor();
        this.selectedComision = row.cxp_codigo;
        row.color = "FT";
    }
    /**
