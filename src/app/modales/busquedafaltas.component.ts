...
@Component({
    standalone: true,
    selector: 'app-busquedafaltas',
    templateUrl: './busquedafaltas.component.html',
    styleUrls: ['./busquedafaltas.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaFaltasComponent implements OnInit {
    /**
