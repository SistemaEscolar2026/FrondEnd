...
@Component({
    standalone: true,
    selector: 'app-busquedagrupo',
    templateUrl: './busquedagrupo.component.html',
    styleUrls: ['./busquedagrupo.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaGrupoComponent implements OnInit {
    /**
  ...
  */
    ngOnInit() {
        this.formagrupo = this.listgrupo;
    }
    /**
