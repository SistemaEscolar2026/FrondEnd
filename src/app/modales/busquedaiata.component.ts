...
@Component({
    standalone: true,
    selector: 'app-busquedaiata',
    templateUrl: './busquedaiata.component.html',
    styleUrls: ['./busquedaiata.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaIataComponent implements OnInit {
    /**
  * DEFINICION DE VARIABLE ENTRADA DE LISTADO DE CLIENTE
  */
    @Input() listadociudad: any[] = [];
    /**
  ...
  */
    ngOnInit() {
        this.formaciudad = this.listadociudad;
    }
    /**
  ...
  */
    limpiarColor() {
        for (var i = 0; i < this.formaciudad.length; i++) {
            this.formaciudad[i].color = "";
        }
    }
    /**
