...
@Component({
    standalone: true,
    selector: 'app-busquedamateria',
    templateUrl: './busquedamateria.component.html',
    styleUrls: ['./busquedamateria.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaMateriaComponent implements OnInit {
    /**
