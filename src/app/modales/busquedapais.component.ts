...
@Component({
    standalone: true,
    selector: 'app-busquedapais',
    templateUrl: './busquedapais.component.html',
    styleUrls: ['./busquedapais.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaPaisComponent implements OnInit {
  ...
  */
    ngOnInit() {
        this.formapais = this.listadopais;
    }
    /**
  ...
  */
    limpiarColor() {
        for (var i = 0; i < this.formapais.length; i++) {
            this.formapais[i].color = "";
        }
    }
    /**
