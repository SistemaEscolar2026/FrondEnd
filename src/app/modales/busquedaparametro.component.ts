...
@Component({
    standalone: true,
    selector: 'app-busquedaparametroo',
    templateUrl: './busquedaparametro.component.html',
    styleUrls: ['./busquedaparametro.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaParametroComponent implements OnInit {
    /**
  * DEFINICION DE VARIABLE ENTRADA DE LISTADO DE CLIENTE
  */
    @Input() listparametro: any[] = [];
    /**
  ...
  */
    ngOnInit() {
        this.formaparametro = this.listparametro;
    }
    /**
  ...
  */
    limpiarColor() {
        for (var i = 0; i < this.formaparametro.length; i++) {
            this.formaparametro[i].color = "";
        }
    }
    /**
