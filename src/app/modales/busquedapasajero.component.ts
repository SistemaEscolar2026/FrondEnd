...
@Component({
  standalone: true,
    selector: 'app-busquedapasajero',
    templateUrl: './busquedapasajero.component.html',
    styleUrls: ['./busquedapasajero.component.scss'],
  imports: [
    FormsModule,
    ReactiveFormsModule,
    MatButtonModule,
...
export class BusquedaPasajeroComponent implements OnInit  {
  /**
* DEFINICION DE VARIABLE ENTRADA DE LISTADO DE CLIENTE
*/
  @Input() listadopasajero: any[] = [];
  /**
...
*/
  ngOnInit() {
      this.pasajero = this.listadopasajero;
  }
  /**
...
*/
  limpiarColor() {
      for (var i = 0; i < this.pasajero.length; i++) {
          this.pasajero[i].color = "";
    }
  }
  /**
