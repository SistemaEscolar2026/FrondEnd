...
@Component({
    standalone: true,
    selector: 'app-busquedapermisoiess',
    templateUrl: './busquedapermisoiess.component.html',
    styleUrls: ['./busquedapermisoiess.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaPermisoiessComponent implements OnInit {
    /**
  * DEFINICION DE VARIABLE ENTRADA DE LISTADO DE CLIENTE
  */
    @Input() listpermisoiess: any[] = [];
    /**
  ...
  */
    ColumnaDetalle: any[] = ['N° Falta', 'Empleado',  'Observacion'];
    /**
  ...
  */
    ngOnInit() {
        this.formaaerolinea = this.listpermisoiess;
    }
    /**
