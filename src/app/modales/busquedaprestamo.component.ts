...
@Component({
    standalone: true,
    selector: 'app-busquedaprestamo',
    templateUrl: './busquedaprestamo.component.html',
    styleUrls: ['./busquedaprestamo.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaPrestamoComponent implements OnInit {
  ...
  */
    ColumnaDetalle: any[] = ['N° Prestamo', 'Empleado',  'Fecha Prestamo'];
    /**
