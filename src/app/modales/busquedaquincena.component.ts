...
@Component({
    standalone: true,
    selector: 'app-busquedaquincena',
    templateUrl: './busquedaquincena.component.html',
    styleUrls: ['./busquedaquincena.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaQuincenaComponent implements OnInit {
    /**
  ...
  */
    ColumnaDetalle: any[] = ['N° Anticipo', 'Año',  'Mes','Valor Anticipo Quincena'];
    /**
  ...
  */
    aceptar() {
        if (this.selectedComision === "") {
            this.toastr.info("Debe seleccionar un Prestamo...", 'Busqueda Prestamo');
        } else {
            this.cerrar();
        }
    }
