...
@Component({
    standalone: true,
    selector: 'app-modalbusquedaretencioniva',
    templateUrl: './busquedaretencioniva.component.html',
    styleUrls: ['./busquedaretencioniva.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaRetencionIvaComponent implements OnInit {
    /**
