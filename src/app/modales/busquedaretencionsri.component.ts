...
@Component({
  standalone: true,
  selector: 'app-busquedaretencionsri',
  templateUrl: './busquedaretencionsri.component.html',
  styleUrls: ['./busquedaretencionsri.component.scss'],
  imports: [
    FormsModule,
    ReactiveFormsModule,
    MatButtonModule,
...
export class BusquedaRetencionSriComponent implements OnInit  {
  /**
* DEFINICION DE VARIABLE ENTRADA DE LISTADO DE CLIENTE
*/
  @Input() listretencionsri: any[] = [];
  /**
...
*/
  ColumnaDetalle: any[] = ['Código', 'Codigo Porcentaje', 'Nombre'];
  /**
...
*/
  ngOnInit() {
    this.retencionsri = this.listretencionsri;
  }
  /**
...
*/
  limpiarColor() {
    for (var i = 0; i < this.retencionsri.length; i++) {
      this.retencionsri[i].color = "";
    }
  }
  /**
...
*/
  aceptar() {
    if (this.selectedCliente === "") {
      this.toastr.info("Debe seleccionar un Tipo Retencion Sri...", 'Busqueda Tipo Retención');
    } else {
      this.cerrar();
    }
  }
