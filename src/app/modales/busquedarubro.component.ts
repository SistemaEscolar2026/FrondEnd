...
@Component({
    standalone: true,
    selector: 'app-busquedarubro',
    templateUrl: './busquedarubro.component.html',
    styleUrls: ['./busquedarubro.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaRubroComponent implements OnInit {
    /**
  ...
  */
    ColumnaDetalle: any[] = ['Codigo', 'Nombre'];
    /**
  ...
  */
    ngOnInit() {
        this.formaaerolinea = this.listrubro;
    }
    /**
