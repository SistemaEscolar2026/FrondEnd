...
@Component({
    standalone: true,
    selector: 'app-busquedaruta',
    templateUrl: './busquedaruta.component.html',
    styleUrls: ['./busquedaruta.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaRutaComponent implements OnInit {
    /**
  * DEFINICION DE VARIABLE ENTRADA DE LISTADO DE CLIENTE
  */
    @Input() listadoruta: any[] = [];
    /**
  ...
  */
    aceptar() {
        if (this.selectedCliente === "") {
            this.toastr.info("Debe seleccionar una Ruta...", 'Busqueda Ruta');
        } else {
            this.cerrar();
        }
    }
