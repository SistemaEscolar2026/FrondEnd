...
@Component({
    standalone: true,
    selector: 'app-busquedaservicioadicional',
    templateUrl: './busquedaservicioadicional.component.html',
    styleUrls: ['./busquedaservicioadicional.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaServicioAdicionalComponent implements OnInit {
    /**
  * DEFINICION DE VARIABLE ENTRADA DE LISTADO DE CLIENTE
  */
    @Input() listaerolinea: any[] = [];
    /**
  ...
  */
    ngOnInit() {
        this.formaaerolinea = this.listaerolinea;
    }
    /**
  ...
  */
    limpiarColor() {
        for (var i = 0; i < this.formaaerolinea.length; i++) {
            this.formaaerolinea[i].color = "";
        }
    }
    /**
