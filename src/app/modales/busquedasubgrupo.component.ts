...
@Component({
    standalone: true,
    selector: 'app-busquedasubgrupo',
    templateUrl: './busquedasubgrupo.component.html',
    styleUrls: ['./busquedasubgrupo.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaSubGrupoComponent implements OnInit {
  ...
  */
    ngOnInit() {
        this.formagrupo = this.listsubgrupo;
    }
    /**
  ...
  */
    aceptar() {
        if (this.selectedComision === "") {
            this.toastr.info("Debe seleccionar un SubGrupo Contable...", 'Busqueda Grupo Contable');
        } else {
            this.cerrar();
        }
    }
