...
@Component({
    standalone: true,
    selector: 'app-busquedatipdocumento',
    templateUrl: './busquedatipdocumento.component.html',
    styleUrls: ['./busquedatipdocumento.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaTipDocumentoComponent implements OnInit {
    /**
  ...
  */
    aceptar() {
        if (this.selectedComision === "") {
            this.toastr.info("Debe seleccionar un Tipo Documento...", 'Busqueda Tipo Documento');
        } else {
            this.cerrar();
        }
    }
