...
@Component({
    standalone: true,
    selector: 'app-busquedatipoalojamiento',
    templateUrl: './busquedatipoalojamiento.component.html',
    styleUrls: ['./busquedatipoalojamiento.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaTipoAlojamientoComponent implements OnInit {
    /**
  * DEFINICION DE VARIABLE ENTRADA DE LISTADO DE CLIENTE
  */
    @Input() listadotipoalojamiento: any[] = [];
    /**
  ...
  */
    formatipoalojamiento: any[] = [];
    /**
  * DEFINICION DE VARIABLE SELECCION DE CLIENTE
  */
    selectedTipoalojamiento: any = [];
    /**
  ...
  */
    constructor(private toastr: ToastrService) {
        this.cargaFormaTipoAlojamiento();
  ...
  */
    ngOnInit() {
        this.formatipoalojamiento = this.listadotipoalojamiento;
    }
    /**
  * DEFINICION DE FUNCION DE CARGA DE COMISION
  */
    cargaFormaTipoAlojamiento() {
  ...
  */
    cerrar() {
        this.confirmacionCierre.emit(this.selectedTipoalojamiento.toString());
    }
    /**
  ...
  */
    limpiarColor() {
        for (var i = 0; i < this.formatipoalojamiento.length; i++) {
            this.formatipoalojamiento[i].color = "";
        }
    }
    /**
  ...
  */
    clickGrid(row: any) {
        this.limpiarColor();
        this.selectedTipoalojamiento = JSON.stringify(row)
        row.color = "FT";
    }
    /**
  ...
  */
    aceptar() {
        if (this.selectedTipoalojamiento === "") {
            this.toastr.info("Debe seleccionar un Tipo Alojamiento...", 'Busqueda Tipo Alojamiento');
        } else {
            this.cerrar();
        }
    }
