...
@Component({
    standalone: true,
    selector: 'app-busquedatipoauxiliar',
    templateUrl: './busquedatipoauxiliar.component.html',
    styleUrls: ['./busquedatipoauxiliar.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaTipoAuxiliarComponent implements OnInit {
    /**
  * DEFINICION DE VARIABLE ENTRADA DE LISTADO DE CLIENTE
  */
    @Input() listtipoauxiliar: any[] = [];
    /**
  ...
  */
    ngOnInit() {
        this.formagrupo = this.listtipoauxiliar;
    }
    /**
  ...
  */
    aceptar() {
        if (this.selectedComision === "") {
            this.toastr.info("Debe seleccionar un Tipo Auxiliar...", 'Busqueda Tipo Auxiliar');
        } else {
            this.cerrar();
        }
    }
