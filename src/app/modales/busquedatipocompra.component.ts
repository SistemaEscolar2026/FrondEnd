...
@Component({
    standalone: true,
    selector: 'app-busquedatipocompra',
    templateUrl: './busquedatipocompra.component.html',
    styleUrls: ['./busquedatipocompra.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaTipoCompraComponent implements OnInit {
    /**
