...
@Component({
    standalone: true,
    selector: 'app-busquedatipodocumento',
    templateUrl: './busquedatipodocumento.component.html',
    styleUrls: ['./busquedatipodocumento.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaTipoDocumentoComponent implements OnInit {
    /**
