...
@Component({
  standalone: true,
  selector: 'app-busquedatiporetencion',
  templateUrl: './busquedatiporetencion.component.html',
  styleUrls: ['./busquedatiporetencion.component.scss'],
  imports: [
    FormsModule,
    ReactiveFormsModule,
    MatButtonModule,
...
export class BusquedaTipoRetencionComponent implements OnInit  {
  /**
* DEFINICION DE VARIABLE ENTRADA DE LISTADO DE CLIENTE
*/
  @Input() listtiporetencion: any[] = [];
  /**
...
*/
  ColumnaDetalle: any[] = ['Código', 'Código Porcentaje','Descripción'];
  /**
* DEFINICION DE VARIABLE CON DATOS DE CLIENTE
*/
  listtiporetenciones: any[] = [];
  /**
...
*/
  ngOnInit() {
    this.listtiporetenciones = this.listtiporetencion;
  }
  /**
...
*/
  limpiarColor() {
    for (var i = 0; i < this.listtiporetenciones.length; i++) {
      this.listtiporetenciones[i].color = "";
    }
  }
  /**
...
*/
  aceptar() {
    if (this.selectedCliente === "") {
      this.toastr.info("Debe seleccionar un Tipo retención...", 'Busqueda Tipo retención');
    } else {
      this.cerrar();
    }
  }
