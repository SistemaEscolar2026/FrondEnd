...
@Component({
  standalone: true,
    selector: 'app-busquedausuario',
    templateUrl: './busquedausuario.component.html',
    styleUrls: ['./busquedausuario.component.scss'],
  imports: [
    FormsModule,
    ReactiveFormsModule,
    MatButtonModule,
...
*/
  ngOnInit() {
      this.usuarios = this.listadousuario;
  }
  /**
