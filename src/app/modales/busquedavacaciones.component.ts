...
@Component({
    standalone: true,
    selector: 'app-busquedavacaciones',
    templateUrl: './busquedavacaciones.component.html',
    styleUrls: ['./busquedavacaciones.component.scss'],
    imports: [
        FormsModule,
        ReactiveFormsModule,
        MatButtonModule,
...
export class BusquedaVacacionesComponent implements OnInit {
  ...
  */
    ColumnaDetalle: any[] = ['Codigo', 'Periodo', 'Inicio Vacaciones', 'Fin Vacaciones'];
    /**
  ...
  */
    ngOnInit() {
        this.formagrupo = this.listvacaciones;
    }
    /**
  ...
  */
    aceptar() {
        if (this.selectedComision === "") {
            this.toastr.info("Debe seleccionar una Solcitud de Vacaciones...", 'Busqueda Vacaciones');
        } else {
            this.cerrar();
        }
    }
