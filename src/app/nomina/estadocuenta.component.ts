...
export class EstadoCuentaEmpleadoComponent {
    ...
    buscarpdf() {
        this.spinner.show();
        this.boletoService.repoteEstadoCuentaEmpleado("PDF", globales.cia, this.iDocumento.empcodigo, "", "", globales.nomMaquina, Funcion.ReturnUsuario().us_login).subscribe((results) => {
            try {
                try {
