...
export class FiniquitoComponent implements OnInit {
  ...
  */
    notifier: any;
    ColumnaDetalle: any[] = ['Rubro', 'Valor'];
    /**
...
*/
   ...
   */
    ...
    limpiarColor() {
        for (var i = 0; i < this.detallefiniquito.length; i++) {
            this.detallefiniquito[i].color = "";
        }
    }
    /**
...
*/
    cargaAerolinea() {
        this.spinner.show();
        this.mantenimientoService.getFaltas(globales.cia).subscribe(data => {
            try {
  ...
  */
    ...
    delete() {
        this.spinner.show();
        this.iFalta.faestado = "D";
        this.mantenimientoService.deleteFalta(this.iFalta).subscribe(data => {
            try {
                if (data.success) {
  ...
  */
    ...
    updateFalta() {
        this.spinner.show();
        this.mantenimientoService.updateFalta(this.iFalta).subscribe(data => {
            try {
                if (data.success) {
                    var mensaje: string = "";
    ...
    insertFalta() {
        this.spinner.show();
        this.iFalta.faestado = "A";
        this.mantenimientoService.insertFalta(this.iFalta).subscribe(data => {
            try {
                if (data.success) {
                    var mensaje: string = "";
                    mensaje = mensaje + data.msgError + "<br/>";
  ...
  */
    seteaParametro(data: any) {
        ...
        this.iFalta.fafecha = moment(data.fafecha).format("YYYY-MM-DD").toString();
  ...
  */
    limpiarparametro() {
        ...
        this.iFalta.fatipo = "";
        this.iFalta.fafecha = moment(new Date()).format("YYYY-MM-DD").toString()
        this.iFalta.fadescuenta = "N";
        this.iFalta.fadescuenta = "N";
        this.iFalta.faestado = "A";
        this.iFalta.faobservacion = "";
    }
  ...
  */
    ...
    mensaje(_tipo: string, _mensaje: string) {
        this.llamarmodal = _tipo + "|Registro Falta|" + _mensaje + "|" + Funcion.Ramdon().toString();
    }
}
