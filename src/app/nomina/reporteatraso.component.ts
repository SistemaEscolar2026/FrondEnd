...
*/
@Component({
    templateUrl: './reporteatraso.component.html',
    styleUrls: ['./reporteatraso.component.scss']
})
 ...
 */
    ...
    buscarexcel() {
        ...
        this.boletoService.repoteBoletos("EXC", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cl_codigo.toString(), _lis, this.iDocumento.us_codigo.toString(), globales.nomMaquina, Funcion.ReturnUsuario().us_codigo).subscribe((results) => {
            try {
    ...
    buscarpdf() {
        ...
        this.spinner.show();
        this.boletoService.repoteBoletos("PDF", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cl_codigo.toString(), _lis, this.iDocumento.us_codigo.toString(), globales.nomMaquina, Funcion.ReturnUsuario().us_codigo).subscribe((results) => {
            try {
                try {
