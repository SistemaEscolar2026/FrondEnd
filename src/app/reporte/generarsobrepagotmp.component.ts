...
*/
@Component({
    templateUrl: './generarsobrepagotmp.component.html',
    styleUrls: ['./generarsobrepagotmp.component.scss']
})
export class GeneraSobrePagoTMPComponent implements OnInit {
    /**
...
*/
  ...
  */
    ...
    calcularnomina() {
        ...
        this.spinner.show();
        this.mantenimientoService.generafinmesTMP(globales.cia, this.nfm_anio, (this.nfm_mes).toString()).subscribe(data => {
            try {
    ...
    procesarsobre() {
        ...
        this.iDocumento.usuario = Funcion.returdatosession("usuario").us_nombre;
        this.iDocumento.detalle = this.detallefinmes

        this.spinner.show();
        this.mantenimientoService.insertNominaFinMesTMP(this.iDocumento).subscribe(results => {
            try {
                try {
