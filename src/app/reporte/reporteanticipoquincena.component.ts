...
*/
@Component({
    templateUrl: './reporteanticipoquincena.component.html',
    styleUrls: ['./reporteanticipoquincena.component.scss']
})
export class ReporteAnticipoQuincenaComponent implements OnInit {
    /**
 ...
 */
    ...
    buscarexcel() {
        this.spinner.show();
        this.boletoService.repoteAnticipoQuincena("EXC", globales.cia, this.iDocumento.naq_anio, this.iDocumento.naq_mes, globales.nomMaquina, Funcion.ReturnUsuario().us_login).subscribe((results) => {
            try {
                ...
                a.href = fileURL;
                a.download = "ReporteAnticipoQuincena.xlsx";
                a.click();
                this.spinner.hide();
    ...
    buscarpdf() {
        this.spinner.show();
        this.boletoService.repoteAnticipoQuincena("PDF", globales.cia, this.iDocumento.naq_anio, this.iDocumento.naq_mes, globales.nomMaquina, Funcion.ReturnUsuario().us_login).subscribe((results) => {
            try {
                try {
    ...
    buscarboleto() {
        this.spinner.show();
        this.boletoService.repoteAnticipoQuincenaVisual("", globales.cia, this.iDocumento.naq_anio, this.iDocumento.naq_mes).subscribe(data => {
            try {
...
*/
  ...
  */
    ...
    mensaje(_tipo: string, _mensaje: string) {
        this.llamarmodal = _tipo + "|Reporte Anticipo Quincena|" + _mensaje + "|" + Funcion.Ramdon().toString();
    }
