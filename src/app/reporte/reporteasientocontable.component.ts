...
*/
@Component({
    templateUrl: './reporteasientocontable.component.html',
    styleUrls: ['./reporteasientocontable.component.scss']
})
export class ReporteAsientoContableComponent implements OnInit {
    /**
  ...
  */
    ...
    modalRef: any;
    llamarmodal: string = "";
    ColumnaDetalle: any[] = ['N° COMPROBANTE', 'TIPO COMPORBANTE', 'CLASE COMPROBANTE', 'FECHA COMPROBANTE', 'GLOSA', 'TOTAL COMPROBANTE', 'TIPO AUXILIAR', 'AUXILIAR', 'N° CUENTA', 'NOMBRE CUENTA', 'DEBER', 'HABER', 'DOC. RELACIONADO'];
 ...
 */
    ...
    buscarexcel() {
        this.spinner.show();
        this.boletoService.repoteComprobante("EXC", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cob_tipo.toString(), globales.nomMaquina, Funcion.ReturnUsuario().us_login).subscribe((results) => {
            try {
                ...
                a.href = fileURL;
                a.download = "ReporteComprobante.xlsx";
                a.click();
                this.spinner.hide();
    ...
    buscarpdf() {
        this.spinner.show();
        this.boletoService.repoteComprobante("PDF", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cob_tipo.toString(), globales.nomMaquina, Funcion.ReturnUsuario().us_login).subscribe((results) => {
            try {
                try {
    ...
    buscarfacturacion() {
        this.spinner.show();
        this.boletoService.repoteComprobanteVisual("", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cob_tipo.toString()).subscribe(data => {
            try {
