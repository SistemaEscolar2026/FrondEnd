...
*/
@Component({
    templateUrl: './reportebalancegeneral.component.html',
    styleUrls: ['./reportebalancegeneral.component.scss']
})
export class ReporteBalanceGeneralComponent implements OnInit {
    /**
 ...
 */
    ...
    buscarexcel() {
        this.spinner.show();
        this.boletoService.repoteBalanceEXE("EXC", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cob_tipo.toString(), globales.nomMaquina, Funcion.ReturnUsuario().us_login).subscribe((results) => {
            try {
                ...
                a.href = fileURL;
                a.download = "ReporteBalance.xlsx";
                a.click();
                this.spinner.hide();
    ...
    buscarpdf() {
        this.spinner.show();
        this.boletoService.repoteBalanceEXE("PDF", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cob_tipo.toString(), globales.nomMaquina, Funcion.ReturnUsuario().us_login).subscribe((results) => {
            try {
                try {
    ...
    buscarbalance() {
        this.spinner.show();
        this.boletoService.repoteBalanceVisual("", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cob_tipo.toString()).subscribe(data => {
            try {
