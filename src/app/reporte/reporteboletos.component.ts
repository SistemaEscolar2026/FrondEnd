...
*/
@Component({
    templateUrl: './reporteboletos.component.html',
    styleUrls: ['./reporteboletos.component.scss']
})
 ...
 */
    ...
    ngOnInit() {
        ...
        var _dato = Funcion.listaColumna();
        _dato.forEach((key: any) => {
            this.codreporte.push(
                key.valor
            );
            this.columnareporte.push({
                id: key.valor,
                text: key.texto
            });
        });
    ...
    buscarboleto() {
        ...
        this.spinner.show();
        this.boletoService.repoteBoletosVisual("", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cl_codigo.toString(), this.iDocumento.us_codigo.toString()).subscribe(data => {
            try {
