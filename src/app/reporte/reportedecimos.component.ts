...
*/
@Component({
    templateUrl: './reportedecimos.component.html',
    styleUrls: ['./reportedecimos.component.scss']
})
export class ReporteDecimosComponent implements OnInit {
    /**
  ...
  */
    ...
    modalRef: any;
    llamarmodal: string = "";
    ColumnaDetalle: any[] = ['Identificacion', 'Nombre Empleado', 'Tipo Decimo', 'Año Proceso', 'Periodo', 'Valor Decimo'];
    /**
 ...
 */
    ...
    buscarexcel() {
        this.spinner.show();
        this.boletoService.repoteDecimos("EXC", globales.cia, this.iDocumento.naq_anio, this.iDocumento.naq_decimo).subscribe((results) => {
            try {
    ...
    buscarpdf() {
        this.spinner.show();
        this.boletoService.repoteDecimos("PDF", globales.cia, this.iDocumento.naq_anio, this.iDocumento.naq_decimo).subscribe((results) => {
            try {
                try {
    ...
    buscarboleto() {
        this.spinner.show();
        this.boletoService.repoteDecimosVisual("", globales.cia, this.iDocumento.naq_anio, this.iDocumento.naq_decimo).subscribe(data => {
            try {
