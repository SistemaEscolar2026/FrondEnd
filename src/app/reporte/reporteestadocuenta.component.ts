...
*/
@Component({
    templateUrl: './reporteestadocuenta.component.html',
    styleUrls: ['./reporteestadocuenta.component.scss']
})
export class ReporteEstadoCuentaComponent implements OnInit {
  ...
  */
    ...
    modalRef: any;
    llamarmodal: string = "";
    ColumnaDetalle: any[] = ['FACTURA', 'FECHA DE FACTURA', 'ENTIDAD', 'FECHA DE FACTURA', 'FECHA DE VENCIMIENTO', 'DIAS VENCIDO', 'VALOR VENCIDO'];
 ...
 */
    ...
    buscarexcel() {
        this.spinner.show();
        this.boletoService.repoteCuentaxCobrarVencido("EXC", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cl_codigo.toString(), globales.nomMaquina, Funcion.ReturnUsuario().us_login).subscribe((results) => {
            try {
    ...
    buscarpdf() {
        this.spinner.show();
        this.boletoService.repoteCuentaxCobrarVencido("PDF", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cl_codigo.toString(), globales.nomMaquina, Funcion.ReturnUsuario().us_login).subscribe((results) => {
            try {
                try {
    ...
    buscarcuentaxcobrar() {
        this.spinner.show();
        this.boletoService.repoteCuentaxCobrarVisualVencido("", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cl_codigo.toString()).subscribe(data => {
            try {
