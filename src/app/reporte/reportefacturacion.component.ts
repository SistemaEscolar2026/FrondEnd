...
*/
@Component({
    templateUrl: './reportefacturacion.component.html',
    styleUrls: ['./reportefacturacion.component.scss']
})
export class ReporteFacturacionComponent implements OnInit {
  ...
  */
    ...
    modalRef: any;
    llamarmodal: string = "";
    ColumnaDetalle: any[] = ['F. Emisión', 'RUC', 'Razón Social', 'Detalle', 'No. Factura', 'No. Autorización', 'Sub. Iva', 'Sub. 0%', 'No Objeto', 'Iva', 'Total', '10%', '20%', '30%', '50%', '70%', '100%', 'Fecha Retención', 'No. Retención', 'No. Autorización'];
 ...
 */
    ...
    buscarexcel() {
        this.spinner.show();
        this.boletoService.repoteFacturacion2("EXC", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cl_codigo.toString(), globales.nomMaquina, Funcion.ReturnUsuario().us_login).subscribe((results) => {
            try {
    ...
    buscarfacturacion() {
        this.spinner.show();
        this.boletoService.repoteFacturacionVisual2("", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cl_codigo.toString()).subscribe(data => {
            try {
