...
*/
@Component({
    templateUrl: './reportefalta.component.html',
    styleUrls: ['./reportefalta.component.scss']
})
export class ReporteFaltaComponent implements OnInit {
    /**
  ...
  */
    ...
    modalRef: any;
    llamarmodal: string = "";
    ColumnaDetalle: any[] = ['COD. EMPLEADO', 'NOMBRE EMPLEADO', 'FECHA DE FALTA', 'TIPO FALTA', 'OBSERVACION FALTA'];
 ...
 */
    ...
    buscarexcel() {
        this.spinner.show();
        this.boletoService.repoteFaltas("EXC", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, (this.iDocumento.empcodigo === undefined) ? "0" : this.iDocumento.empcodigo.toString()).subscribe((results) => {
            try {
    ...
    buscarpdf() {
        this.spinner.show();
        this.boletoService.repoteFaltas("PDF", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, (this.iDocumento.empcodigo === undefined) ? "0" : this.iDocumento.empcodigo.toString()).subscribe((results) => {
            try {
                try {
    ...
    buscarfalta() {
        this.spinner.show();
        this.boletoService.repoteFaltasVisual("", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, (this.iDocumento.empcodigo === undefined) ? "0" : this.iDocumento.empcodigo.toString()).subscribe(data => {
            try {
...
*/
  ...
  */
    ...
    mensaje(_tipo: string, _mensaje: string) {
        this.llamarmodal = _tipo + "|Reporte de Falta|" + _mensaje + "|" + Funcion.Ramdon().toString();
    }
