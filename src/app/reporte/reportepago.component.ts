...
@Component({
    ...
    styleUrls: ['./reportepago.component.scss']
})
 ...
 */
    ...
    buscarexcel() {
        this.spinner.show();
        this.boletoService.repotePago("EXC", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cl_codigo.toString()).subscribe((results) => {
            try {
    ...
    buscarpdf() {
        this.spinner.show();
        this.boletoService.repotePago("PDF", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cl_codigo.toString()).subscribe((results) => {
            try {
                try {
    ...
    buscarpago() {
        this.spinner.show();
        this.detallereporte = [];
        this.boletoService.repotePagoVisual("", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cl_codigo.toString()).subscribe(data => {
            try {
