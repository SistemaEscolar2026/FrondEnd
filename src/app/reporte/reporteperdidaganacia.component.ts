...
*/
@Component({
    templateUrl: './reporteperdidaganacia.component.html',
    styleUrls: ['./reporteperdidaganacia.component.scss']
})
export class ReportePerdidaGanaciaComponent implements OnInit {
    /**
  ...
  */
    ...
    modalRef: any;
    llamarmodal: string = "";
    ColumnaDetalle: any[] = ['N° CUENTA','DESCRIPCION CUENTA','TIPO CUENTA', 'SALDO DEBE', 'SALDO HABER', 'SALDO DEBE ACUMULADO', 'SALDO HABER ACUMULADO', 'SALDO', 'SALDO ACUMULADO'];
 ...
 */
    ...
    buscarexcel() {
        this.spinner.show();
        this.boletoService.repotePerdidaEXE("EXC", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cob_tipo.toString(), globales.nomMaquina, Funcion.ReturnUsuario().us_login).subscribe((results) => {
            try {
                ...
                a.href = fileURL;
                a.download = "ReportePerdidaGanacia.xlsx";
                a.click();
                this.spinner.hide();
    ...
    buscarpdf() {
        this.spinner.show();
        this.boletoService.repotePerdidaEXE("PDF", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cob_tipo.toString(), globales.nomMaquina, Funcion.ReturnUsuario().us_login).subscribe((results) => {
            try {
                try {
    ...
    buscarbalance() {
        this.spinner.show();
        this.boletoService.repotePerdidaVisual("", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cob_tipo.toString()).subscribe(data => {
            try {
