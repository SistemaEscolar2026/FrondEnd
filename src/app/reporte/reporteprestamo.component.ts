...
*/
@Component({
    templateUrl: './reporteprestamo.component.html',
    styleUrls: ['./reporteprestamo.component.scss']
})
export class ReportePrestamoComponent implements OnInit {
    /**
  ...
  */
    ...
    modalRef: any;
    llamarmodal: string = "";
    ColumnaDetalle: any[] = ['COD. EMPLEADO', 'NOMBRE EMPLEADO','NUMERO DE PRESTAMO', 'FECHA DE PRESTAMO', 'VALOR PRESTAMO','NUMERO CUOTA', 'OBSERVACION PRESTAMO'];
 ...
 */
    ...
    buscarexcel() {
        this.spinner.show();
        this.boletoService.repotePrestamo("EXC", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, (this.iDocumento.empcodigo === undefined) ? "0" : this.iDocumento.empcodigo.toString()).subscribe((results) => {
            try {
                ...
                a.href = fileURL;
                a.download = "ReportePrestamo.xlsx";
                a.click();
                this.spinner.hide();
    ...
    buscarpdf() {
        this.spinner.show();
        this.boletoService.repotePrestamo("PDF", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, (this.iDocumento.empcodigo === undefined) ? "0" : this.iDocumento.empcodigo.toString()).subscribe((results) => {
            try {
                try {
    ...
    buscaradelanto() {
        this.spinner.show();
        this.boletoService.repotePrestamoVisual("", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, (this.iDocumento.empcodigo === undefined) ? "0" : this.iDocumento.empcodigo.toString()).subscribe(data => {
            try {
...
*/
  ...
  */
    ...
    mensaje(_tipo: string, _mensaje: string) {
        this.llamarmodal = _tipo + "|Reporte de Prestamo|" + _mensaje + "|" + Funcion.Ramdon().toString();
    }
