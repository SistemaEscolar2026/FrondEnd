...
*/
@Component({
    templateUrl: './reporteproveedor.component.html',
    styleUrls: ['./reporteproveedor.component.scss']
})
export class ReporteProveedorComponent implements OnInit {
  ...
  */
    ...
    modalRef: any;
    llamarmodal: string = "";
    ColumnaDetalle: any[] = ['TIPO IDENTIFICACION', 'IDENTIFICACION', 'NOMBRE PROVEEDOR', 'TELEFONO', 'DIRECCION', 'CORREO', 'FECHA CREACION', 'ESTADO'];
