...
*/
@Component({
    templateUrl: './reportevacaciones.component.html',
    styleUrls: ['./reportevacaciones.component.scss']
})
export class ReporteVacacionesComponent implements OnInit {
  ...
  */
    ...
    modalRef: any;
    llamarmodal: string = "";
    ColumnaDetalle: any[] = ['COD. EMPLEADO', 'NOMBRE EMPLEADO', 'FECHA SOLICITUD VACACIONES', 'PERIODO VACACIONES', 'FECHA INICIO VACACIONES','FECHA FIN VACACIONES', 'DIAS VACACIONES'];
 ...
 */
    ...
    buscarexcel() {
        this.spinner.show();
        this.boletoService.repoteVacaciones("EXC", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, (this.iDocumento.empcodigo === undefined) ? "0" : this.iDocumento.empcodigo.toString()).subscribe((results) => {
            try {
                ...
                a.href = fileURL;
                a.download = "ReporteVacaciones.xlsx";
                a.click();
                this.spinner.hide();
    ...
    buscarpdf() {
        this.spinner.show();
        this.boletoService.repoteVacaciones("PDF", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, (this.iDocumento.empcodigo === undefined) ? "0" : this.iDocumento.empcodigo.toString()).subscribe((results) => {
            try {
                try {
    ...
    buscaradelanto() {
        this.spinner.show();
        this.boletoService.repoteVacacionesVisual("", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, (this.iDocumento.empcodigo === undefined) ? "0" : this.iDocumento.empcodigo.toString()).subscribe(data => {
            try {
...
*/
  ...
  */
    ...
    mensaje(_tipo: string, _mensaje: string) {
        this.llamarmodal = _tipo + "|Reporte de Vacaciones|" + _mensaje + "|" + Funcion.Ramdon().toString();
    }
