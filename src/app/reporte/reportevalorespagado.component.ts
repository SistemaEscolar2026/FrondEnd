...
*/
@Component({
    templateUrl: './reportevalorespagado.component.html',
    styleUrls: ['./reportevalorespagado.component.scss']
})
export class ReporteValoresPagadoComponent implements OnInit {
    /**
 ...
 */
    ...
    cancelar() {
        ...
        this.iDocumento.fp_codigo = 0;
        this.iDocumento.fp_nombre = "";
    }
    buscarexcel() {
        this.spinner.show();
        this.boletoService.repoteForma("EXC", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cl_codigo.toString(), this.iDocumento.fp_codigo.toString(), globales.nomMaquina, Funcion.ReturnUsuario().us_login).subscribe((results) => {
            try {
                ...
                a.href = fileURL;
                a.download = "ReporteFormaPago.xlsx";
                a.click();
                this.spinner.hide();
    ...
    buscarpdf() {
        this.spinner.show();
        this.boletoService.repoteForma("PDF", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cl_codigo.toString(), this.iDocumento.fp_codigo.toString(), globales.nomMaquina, Funcion.ReturnUsuario().us_login).subscribe((results) => {
            try {
                try {
    ...
    buscarboleto() {
        this.spinner.show();
        this.boletoService.repoteFormaVisual("", globales.cia, this.iDocumento.bc_fecha_inicio_viaje, this.iDocumento.bc_fecha_fin_viaje, this.iDocumento.cl_codigo.toString(), this.iDocumento.fp_codigo.toString()).subscribe(data => {
            try {
