...
export class CuentaxCobrarService {
    /**
  * CONSTRUCTOR DE LA CLASE
  */
    constructor(private _httpClient: HttpClient) { }
    cargapagoboleto(par1: string, par2: string, par3: string) {
        var parambusquedad = {
            par1: par1,
            par2: par2,
            par3: par3
        }
        return this._httpClient.post<any>(`${environment.API_URLLOGIN}/${environment.cuentaxcobrar}CargaBoletoPago`, parambusquedad, { headers: headersglobal.headers }).pipe(timeout(500000))
    }
