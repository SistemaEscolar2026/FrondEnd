...
*/
@Component({
    selector: 'app-cuadraturaiva',
    templateUrl: './cuadraturaiva.component.html',
    styleUrls: ['./cuadraturaiva.component.scss']
})
export class CuadraturaIvaComponent {
    ...
    buscarexcel() {
        this.spinner.show();
        this.boletoService.repoteCuadreiva("EXC", globales.cia, this.dp_fechaIni, this.dp_fechaFin, "", globales.nomMaquina, Funcion.ReturnUsuario().us_login).subscribe((results) => {
            try {
                ...
                a.href = fileURL;
                a.download = "ReporteCuadreIva.xlsx";
                a.click();
                this.spinner.hide();
    ...
    buscarpdf() {
        this.spinner.show();
        this.boletoService.repoteCuadreiva("PDF", globales.cia, this.dp_fechaIni, this.dp_fechaFin, "", globales.nomMaquina, Funcion.ReturnUsuario().us_login).subscribe((results) => {
            try {
                try {
